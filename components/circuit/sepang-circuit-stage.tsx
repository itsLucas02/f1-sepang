...
export function SepangCircuitStage({
  ...
  return (
    <div
      ...
      className="relative min-h-[390px] overflow-hidden rounded-lg border border-white/10 bg-[#09090b] shadow-[0_30px_80px_-20px_rgba(0,0,0,0.85)] sm:min-h-[480px] lg:min-h-[620px]"
    >
      ...
      <div className="pointer-events-none absolute inset-x-0 top-0 z-20 flex items-start justify-between gap-5 bg-gradient-to-b from-black/80 via-black/28 to-transparent p-5 pb-16 sm:p-7 sm:pb-20">
        <div>
          <p className="font-mono text-[10px] uppercase tracking-[0.15em] text-text-secondary sm:text-[11px]">
        ...
        <div className="flex gap-5 text-right sm:gap-8">
          <div>
            ...
            <p className="font-mono text-[9px] uppercase tracking-[0.12em] text-text-muted">KM</p>
          </div>
          <div>
            <p className="font-display text-2xl font-extrabold text-white sm:text-3xl">15</p>
            <p className="font-mono text-[9px] uppercase tracking-[0.12em] text-text-muted">Turns</p>
          </div>
        </div>
      </div>
