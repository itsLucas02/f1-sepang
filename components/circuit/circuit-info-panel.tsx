...
export function CircuitInfoPanel({
  ...
  return (
    <aside className="panel-enter relative flex min-h-full flex-col overflow-hidden rounded-lg border border-white/10 bg-surface-01 p-6 text-foreground sm:p-8 lg:p-9">
      <div
        aria-hidden="true"
        className="absolute -right-5 -top-10 font-display text-[10rem] font-extrabold leading-none text-white/[0.045]"
      >
        {hotspot.index}
      </div>
      ...
      <div className="relative">
        <div className="flex items-center gap-3">
          ...
          <p className="font-mono text-[10px] font-medium uppercase tracking-[0.16em] text-text-muted sm:text-[11px]">
      ...
      <div className="relative mt-8 rounded-r-md border-l-[3px] border-race-red bg-race-red/[0.07] py-4 pl-5 pr-4">
      ...
      <div className="relative mt-auto pt-10">
        <div className="border-t border-white/10 pt-6">
          {sepangReady ? (
            <div>
              <p className="font-mono text-[10px] font-medium uppercase tracking-[0.16em] text-teal">
